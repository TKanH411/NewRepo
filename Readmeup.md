...
![](/image/Screenshot%202024-03-29%20135352.png)
...
![](/image/Untitled_bppkvk.webp)
## Trộn (Merge)
Trộn source từ một nhánh khác vào nhánh hiện tại.

![](/image/git-merge-gop-cac-nhanh-thanh-nhanh-duy-nhat-2-1.png)
...
![](/image/git-conflict-example.png)
...
![](/image/2fb15968-b691-4ab2-af60-18a0514a5e68.webp)
![](/image/git-term-3-1.png)
## Git Remote
